...
public class SessionData {
     ...
     */
    private OpenlinkCommand.Action executeAction;

    private List<OpenlinkCommand.Action> allowedActions = new ArrayList<OpenlinkCommand.Action>();
    ...
    OpenlinkCommand.Action getExecuteAction() {
        return executeAction;
    }

    void setExecuteAction(OpenlinkCommand.Action executeAction) {
     ...
     */
    void setAllowedActions(List<OpenlinkCommand.Action> allowedActions) {
        if (allowedActions == null) {
            allowedActions = new ArrayList<OpenlinkCommand.Action>();
        }
    ...
    boolean isValidAction(String actionName) {
        for (OpenlinkCommand.Action action : allowedActions) {
