...
public class RtmpFactory
{
	...
	public static RtmpPacket publishNotify ( double clientIdX , String streamNameX )
	{

		// System.out.println( System.currentTimeMillis( ) + " RtmpFactory.playStart " + streamIdX + " " + streamNameX );

		WrapperMap start = new WrapperMap( Library.STATUSKEYS , Library.PUBLISHNOTIFYARR );
		RtmpPacket packet = new RtmpPacket( );
		WrapperList arguments = invokeRoot( "onStatus" );
	...
	public static RtmpPacket unPublishNotify ( double clientIdX , String streamNameX )
	{

		// System.out.println( System.currentTimeMillis( ) + " RtmpFactory.playStart " + streamIdX + " " + streamNameX );

		WrapperMap start = new WrapperMap( Library.STATUSKEYS , Library.UNPUBLISHNOTIFYARR );
		RtmpPacket packet = new RtmpPacket( );
		WrapperList arguments = invokeRoot( "onStatus" );
