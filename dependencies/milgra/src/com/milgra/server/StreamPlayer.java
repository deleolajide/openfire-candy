...
public class StreamPlayer extends OStream
{
	...
	public void disable ( )
	{
		...
		if ( controller != null ) controller.client.addOutgoingPacket( packet );
			...
			synchronized ( buffer )
			{
				...
				switch ( packetX.bodyType )
				{
					...
					case 0x08 :
						...
						if ( controller == null || (!controller.dropAudio && sendAudio) )
						{

							//System.out.println( System.currentTimeMillis() + " " + name + " StreamPlayer.takePacket audio " + packetX );
	...
	public long getClientId ( )
	{
		...
		return controller != null ? controller.client.id : -1;
